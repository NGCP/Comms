   ...
   msg_offset offset)
{
   ...
   offset = pack_float32_t(vehicle_waypoint_command->latitude,offset);
   offset = pack_float32_t(vehicle_waypoint_command->longitude,offset);
   offset = pack_float32_t(vehicle_waypoint_command->altitude,offset);
   return offset;
}
   ...
   vehicle_waypoint_command_t* out_ptr)
{
   ...
   offset = unpack_float32_t(offset, &out_ptr->latitude);
   offset = unpack_float32_t(offset, &out_ptr->longitude);
