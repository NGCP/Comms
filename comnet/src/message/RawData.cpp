...
msg_offset pack_raw_data(
   ...
   msg_offset offset)
{
   offset = pack_float64_t(raw_data->timestamp,offset);
   offset = pack_uint16_t(raw_data->length,offset);
   offset = pack_uint8_t(raw_data->data,offset);
   return offset;
}
   ...
   raw_data_t* out_ptr)
{
   ...
   offset = unpack_uint16_t(offset, &out_ptr->length);
   offset = unpack_uint8_t(offset, &out_ptr->data);
   return offset;
}
...

{
   ...
   msg->header.message_type = Com_Raw_Data;
   ...
   offset = pack_raw_data(tx_msg, offset);
