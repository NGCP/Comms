...
msg_offset pack_target_status(
   ...
   msg_offset offset)
{
   offset = pack_float64_t(target_status->timestamp,offset);
   offset = pack_float64_t(target_status->target_radius,offset);
   offset = pack_float64_t(target_status->target_angle,offset);
   offset = pack_float64_t(target_status->target_altitude,offset);
   return offset;
}
   ...
   target_status_t* out_ptr)
{
   ...
   offset = unpack_float64_t(offset, &out_ptr->target_radius);
   offset = unpack_float64_t(offset, &out_ptr->target_angle);
   offset = unpack_float64_t(offset, &out_ptr->target_altitude);
   return offset;
}
...

{
   ...
   msg->header.message_type = Com_Target_Status;
   ...
   offset = pack_target_status(tx_msg, offset);
