...
msg_offset pack_payload_bay_status(
   ...
   msg_offset offset)
{
   offset = pack_float64_t(payload_bay_status->timestamp,offset);
   offset = pack_uint16_t(payload_bay_status->payload_bay_ID,offset);
   offset = pack_uint8_t(payload_bay_status->payload_bay_mode,offset);
   offset = pack_uint8_t(payload_bay_status->payload_status,offset);
   return offset;
}
   ...
   payload_bay_status_t* out_ptr)
{
   ...
   offset = unpack_uint8_t(offset, &out_ptr->payload_bay_mode);
   offset = unpack_uint8_t(offset, &out_ptr->payload_status);
   return offset;
}
...

{
   ...
   msg->header.message_type = Com_Payload_Bay_Status;
   ...
   offset = pack_payload_bay_status(tx_msg, offset);
