...
msg_offset pack_payload_operating_status(
   ...
   msg_offset offset)
{
   offset = pack_float64_t(payload_operating_status->timestamp,offset);
   offset = pack_uint16_t(payload_operating_status->payload_ID,offset);
   offset = pack_uint8_t(payload_operating_status->payload_mode,offset);
   offset = pack_uint8_t(payload_operating_status->payload_status,offset);
   return offset;
}
   ...
   payload_operating_status_t* out_ptr)
{
   ...
   offset = unpack_uint16_t(offset, &out_ptr->payload_ID);
...

{
   ...
   msg->header.message_type = Com_Payload_Operating_Status;
   ...
   offset = pack_payload_operating_status(tx_msg, offset);
