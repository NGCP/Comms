...
from .comnet_file_include import *
from .comnet_file_src import *
from .comnet_message_include import *
from .comnet_message_src import *

def generate_comnet(directory, include_extension, src_extension, inputDirectory):
    """
    ...
    generate_comcol_file_include(directory, include_extension, src_extension)
    generate_comcol_file_src(directory, include_extension, src_extension)
    generate_comnet_file_include(directory, include_extension, src_extension)
    generate_comnet_file_src(directory, include_extension, src_extension)    
    #copy native files
