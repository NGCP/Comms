...
def generate_comnet_file_include(directory, include_extension, src_extension):
    """
    Function will create the comnet header file in .../include/
    File has 2 main parts
        -message callback comtypes
        -class node
            -public functions
            -public send_message
    ...
    tab = '   '
    #open file
    f = open(directory + "/include/" + 'comnet' + include_extension, 'w')
    # warning
    f.write('/**@file This file was autogenerated. All changes will be undone. */\n\n')
    # include guards
    f.write('#ifndef _COMNET_H_\n')
    f.write('#define _COMNET_H_\n\n')
    #include files
...
""")   
    ...
    #for each message declare comtype of call back function
    for message in comcol:
        ...
        f.write(tab+'typedef void* (*'+ variable_name+'_callback)(int8_t, com_header_t, '+type_t_name+', comnet::node* node_ptr);\n')
    ...
    f.write(tab+tab+'com_msg_queue queue;\n')
    
    f.write(tab+tab+'/**Add key to comnet class*/\n')
    ...
    f.write(tab+tab+'void handle_com_msg_t(com_msg_t* rx_msg, com_msg_buf_t* rx_buf);\n\n')
    ...
    f.write(tab+tab+'void* comnet_handler();\n')
    ...
    print("Created: " + 'comnet' + include_extension)