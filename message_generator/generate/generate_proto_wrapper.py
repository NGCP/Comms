...
def generate_proto_wrapper(directory, include_extension, src_extension, deleteNew):
    """
    ...
    if(deleteNew == True):
        ...
        generate_proto_wrapper_include(directory + "/include/", include_extension, src_extension)
        generate_proto_wrapper_src(directory + "/src/", include_extension, src_extension)
