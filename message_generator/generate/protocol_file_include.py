...
def generate_comcol_file_include(directory, include_extension, src_extension):
    """
    Function will create the comcol header file in .../include/
    File has 4 main parts
        -include all message header files
        -union of all messages
        -unpack function
        -com_typster function
    """
    ...
    tab = '   '  
    #open file
    f = open(directory + "/include/" + 'comnet_protocol' + include_extension, 'w')
    # warning
    ...
    f.write('const uint8_t MSG_DATA_OFFSET = 26;\n\n')
    
    #create a union with all the message types as com_msg_buf_t
    ...
    f.write('} com_msg_buf_t;\n\n')
    
    #declare unpack function
    f.write("/**Global function to unpack message with com_msg and com_msg_bug_t union.*/\n")
    ...
    print("Created: " + 'comnet_protocol' + include_extension)