...
def generate_comcol_file_src(directory, include_extension, src_extension):
    """
    Function will create the comcol source file in .../src/
    ...
    tab = '   '    
    #open file
    f = open(directory + "/src/" + 'comnet_comcol' + src_extension, 'w')
    # warning
    ...
    print("Created: " + 'comnet_comcol' + src_extension)